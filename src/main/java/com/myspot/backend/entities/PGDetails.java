...
@Table(name = "pg_details", indexes = {
    @Index(name = "idx_pg_details_pg_id", columnList = "pg_id"),
...
@AllArgsConstructor
@Builder
@ToString(exclude = {"pgManagement"})
@EqualsAndHashCode(of = {"pgDetailsId", "pgManagement"})
public class PGDetails {
    ...
    private PGManagement pgManagement;
